...
<div class="container-fluid">
    ...
    <!-- Content Row -->
    <?php  if($usertype == 'College_Counselor')  {    ?>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
           <h4>Pending Student Connection Requests</h4> 
        </div>
    </div>
    <?php  }  ?>
    ...
    <div class="row">   
        <div class="col-xl-12 col-md-12 mb-12">
            ...
            $qry = "SELECT * FROM `counselor_request` WHERE req_to_couselorID = '" . $user_id . "' and approval_status = 0";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    $email = $coundelor_detail['counselor_email'];
                    //print_r($row);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 widget-26-contact-info">
                                        <p>  
                                            ...
                                            <a data-id="<?php echo $cnslrIds; ?>" class="btn btn-primary" href="<?php echo $murltk; ?>">View Request</a>
                ...
                <div class="row" style="border-top: 1px solid #ddd;padding:15px 0 15px;">
                    <div class="col-md-12">
                        <p>You do not have any student connection requests.</p>
                    </div>
                </div>
                <?php
            }    
                  ...
                  $user_id = $_SESSION['userid'];
            //$qry = "SELECT * FROM `counselor_request` WHERE req_to_couselorID = '" . $user_id . "' and approval_status = 1";
            $qry = "SELECT * FROM `counselor_request` WHERE req_by_id = '" . $user_id . "' and approval_status = 0";
            //$qry = "SELECT * FROM `counselor_dash_message` WHERE to_id = '" . $user_id . "' AND dismiss != 1";
            $result = $con->query($qry);
            ...
            if ($result->num_rows > 0) {
                ...
                <div class="row" style="border-top: 1px solid #ddd;padding:15px 0 15px;">
                    <div class="col-md-12">
                        <p>You do not have any connection requests.</p>
                    </div>
                </div>
                <?php
            }   
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
           <h4>Accepted Connection Requests</h4> 
        </div>
    </div>
    <?php  }  else  {  ?>
    <div class="row">
        <div class="col-md-12 col-sm-12">
           <h4>Accepted Student Connection Requests</h4> 
        </div>
    </div>
    <?php  }  ?>
    <div class="row">   
		...
		<?php	 }			
         ...
         $qry = "SELECT * FROM `counselor_request` WHERE req_by_id = '" . $user_id . "' AND approval_status=1 ";
            ...
            if ($result->num_rows > 0) {
				...
				<div class="row" style="border-top: 1px solid #ddd;padding:15px 0 15px;">
                    <div class="col-md-12">
                        <p>You have not accepted any connection requests.</p>
                    </div>
                </div>
		<?php	 }	
