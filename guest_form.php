		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 px-0 overflow-hide">
				<div id="progress-bar">
					...
					<div id="2"class="two progress-bar-item progress-bar-item-edges" ><a href="#!" class="white-font"><p class="progress-bar-text">Results</p></a></div>
...
<!--<div class="col-11 col-sm-12 col-md-12 col-lg-12 text-center p-0 mt-3 mb-2">
    ...
    <form id="SignupForm" method="post" action='guest_college-search.php'>
  ...
  <div class="modal-dialog">
    <div class="modal-content  p-sm-3">
      ...
      <div class="modal-body">
        ...
        <p class="text-3">
        Isuriz's College List Builder is provided free for the public to use to giveback to the community and is provided "AS IS." Isuriz makes no warranties, express or implied, and hereby disclaims all implied warranties, including any warranty of merchantability and warranty of fitness for a particular purpose. By clicking the "I Agree" button you agree that you have fully read and understand this disclaimer and assume all risk for using Isuriz's College List Builder.
        </p>
      ...
      <div class="modal-footer border-0 d-block">
		...
		<p class="text-center position-relative small">
			<input type="checkbox" id="dont-show-disclaimer" class="me-2 position-relative"> Don't Show Me Again
		</p>
