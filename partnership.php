   ...
   $sql ="INSERT INTO `Partnership` (`first_name`, `last_name`, `phone`, `company`, `street`, `city`, `state`, `postal_code`, `country`, `email`, `primary_url`, `aff_id`) 
    ...
    if(mysqli_query($con, $sql)){
      ...
      $message = "
        <html>
        <head>
        <title>Welcome New Isuriz Partner</title>
        </head>
        <body>
        <p>Welcome to the <a href='https://www.isuriz.com/'>Isuriz</a> Partnership Program! Here are a couple features we would like to highlight:</p>
        ...
        <br>
        <br>
		If you have any questions, please do not hesitate to contact us at support@isuriz.com. We look forward to working with you!
		<br>
        <br>
        Regards, 
		<br>
