		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 px-0 overflow-hide">
				<div id="progress-bar">
						...
						<div id="3"class="done results progress-bar-item progress-bar-item-edges" ><a href="guest_form2.php" class="white-font"><p class="progress-bar-text">My Profile</p></a></div>
   ...
   <div class="container">
     ...
     <!-- <div class="container-fluid" >
      ...
      <!-- <form action="form.php" method="post" id="SignupForm" > -->
         <form action="guest_results.php" method="post" id="SignupForm" >
        
         <fieldset >
            <!-- <legend>Disclaimer</legend> -->
            <div class="mform_field_wrap disclaimer-text position-relative" style="padding: 0px !important; display: flex; max-height: 330px;overflow: auto; background: url('/img/7.jpeg') 50% 50% no-repeat; background-size: cover; max-width: 600px; ">
				
				<!-- <img src="/img/7.jpeg" class="d-block w-100" alt="..."> -->
				<span class="d-block" style="background-color: rgba(0,0,0,1); padding: 6rem 3rem;">
				
					<p class="text-white text-3" style="line-height: 1.8em;">FIRST TELL US A LITTLE ABOUT YOURSELF BY CREATING A PROFILE IN ORDER TO ESTIMATE YOUR CHANCES OF ACCEPTANCE</p>

				</span>

			   <!-- <p style="text-align: justify">
			   FIRST TELL US A LITTLE ABOUT YOURSELF BY CREATING A PROFILE IN ORDER TO ESTIMATE YOUR CHANCES OF ACCEPTANCE
               </p> -->
            </div>
         </fieldset>
         <fieldset>
...
<textarea name="activity_details_10" maxlength="150" id="activity_details_10" class="activity_details_textarea" placeholder="Please describe this activity, including what you accomplished and any recognition you received, etc."></textarea>
		 ...
		 <p style="margin-top: 35px;">
            <button name="btnform2" id="SaveAccount" class="btn btn-primary submit mybluebtn">Submit form</button>
         </p>
      </form>
   </div>
</div>
