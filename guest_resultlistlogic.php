	...
	<div class="container-fluid">
		<div class="row">
		 ...
		 <div id="progress-bar">
					...
					<div id="5" class="done five progress-bar-item" ><a href="guest_resultlistlogic.php" class="white-font"><p class="progress-bar-text">Finalize List</p></a></div>
			</div>
      ...
      <div class="col-sm-12 col-md-12">
	   ...
	   <div class="row">
		  <div class="mt-30 mb-30 blueBtnBigdiv text-center">
			  <a href="guest_results.php" class="btn btn-default prev mybluebtn blue-outline btn-center-xs" >Back</a>
			  <a href="guest_college-list.php" class="blueBtnBig prev myblueBtnBig" aria-hidden="false">Finalize List</a>
		  </div>
	   </div>
      <!--buttons-->
</section>
