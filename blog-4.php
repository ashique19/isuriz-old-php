...
<section class="row m-0 p-0">
  <section class="col-12 m-0 p-0">
      <div class="cover about text-white">
        ...
        <h1 class="text-center title-3 py-4">Potential Mistakes to Avoid When Choosing a College</h1>
        <p class="text-center">
        ISURIZ | NOVEMBER 05, 2020
        </p>
      </div>
  </section>
</section>
  ...
  <section class="col-12 col-sm-10">
    ...
    <div class="card shadow p-4">
      ...
      <div class="card-header text-center bg-white border-0">
        <img src="/img/blog-4.jpeg" alt="" class="img-fluid">
      </div>
