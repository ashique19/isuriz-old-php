         ...
         <section class="section-container">
            ...
            <div class="content-wrapper">
               <div class="content-heading" id="welcometext-div">
                  <div><h3 class="text-center" id="welcometext-mb" style="color: #3a3a3a">Edit Profile</h3><small data-localize="dashboard.WELCOME"></small></div>
               </div>
...
<section>
  <div class="container-fluid" style="padding-left: 15px;padding-right: 15px;">
    ...
    <div id="sub-category-profile" class="sub-category" style="display: inline-grid;">
