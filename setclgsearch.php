   ...
   //echo "<pre>";
	...
	if(!empty($tuitionMax) || !empty($tuitionMin)){		
		...
		if(!empty($tuitionMin) && !empty($tuitionMax) ){	
			$ids_sql = "SELECT UNITID FROM `ic2019_py` WHERE `CHG1PY3` >= '".$tuitionMin."' AND `CHG1PY3` <= '".$tuitionMax."'";
			$ids_sql_1 = "SELECT UNITID FROM `ic2019_ay` WHERE `CHG2AY3` >= '".$tuitionMin."' AND `CHG2AY3` <= '".$tuitionMax."'";

		}elseif (!empty($tuitionMin) && empty($tuitionMax)) {
			$ids_sql = "SELECT UNITID FROM `ic2019_py` WHERE `CHG1PY3` >= '".$tuitionMin."'";
			$ids_sql_1 = "SELECT UNITID FROM `ic2019_ay` WHERE `CHG2AY3` >= '".$tuitionMin."'";	
			
		}elseif (empty($tuitionMin) && !empty($tuitionMax)) {
			$ids_sql = "SELECT UNITID FROM `ic2019_py` WHERE `CHG1PY3` <= '".$tuitionMax."'";
			$ids_sql_1 = "SELECT UNITID FROM `ic2019_ay` WHERE `CHG2AY3` <= '".$tuitionMax."'";
		}
		...
		$clgidarr = array();
		$sql_kala = "SELECT * FROM hd2019 ".$condition ." " ;
		...
		$sql = "SELECT * FROM hd2019 ".$condition ." ORDER BY `hd2019`.`INSTNM` ASC LIMIT 0,30" ;
		$result = $con->query($sql);			
