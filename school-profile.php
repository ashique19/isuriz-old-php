  ...
  <div class="row main-container">
    <div class="col-md-3 col-sm-3 sidebar-section">
      <div class="tab">
        ...
        <button class="tablinks" onclick="openCity(event, 'changeProfile')" id="btn_changeProfile">
          <i class="fa fa-check-circle" aria-hidden="true"></i>
          User Input       
...
?>
      ...
      ?>
        ...
        <div class="col-sm-12" id="attenGenStatus">
          ...
          <table class="table graphtabs desktopView">
            <thead>
              <tr>
          ...
          <div class="mobile-view">
            <?php if(!empty($undergraduateAttendence)): ?>
              <div class="col-sm-12 col-md-12">
                <center><label class="text-center">UNDERGRADUATE ATTENDANCE STATUS</label></center><br />
                <?php echo piechartGenerator($undergraduateAttendence,'undergraduateAttendence'); ?>
              </div>
            <?php endif; ?>

            <?php if(!empty($undergraduateGender)): ?>
              <div class="col-sm-12 col-md-12">
                <center><label class="text-center">UNDERGRADUATE STUDENT GENDER</label></center><br />
                <?php echo piechartGenerator($undergraduateGender,'undergraduateGender'); ?>
              </div> 
            <?php endif; ?>
          </div>
        ...
        <div class="col-sm-12" id="ageRegidence">
          ...
          <?php endif; ?>
          <div class="mobile-view">
            <?php if(!empty($undergraduateAge)): ?> 
              <center><label class="text-center">UNDERGRADUATE STUDENT AGE</label></center> <br />
              <?php echo barchartGenerator($undergraduateAge,'undergraduateAge'); ?>
            <?php endif; ?>

            <?php if(!empty($undergraduateResidence)): ?> 
              <label class="text-center">UNDERGRADUATE STUDENT RESIDENCE</label> <br />
              <?php echo barchartGenerator($undergraduateResidence,'undergraduateResidence'); ?>
            <?php endif; ?>
          </div>
        </div>
...
echo "<p class='note'>Institutions that did not offer undergraduate programs were not required to report Outcome Measures.</p>";
      ...
      <div id="athleticTeam" class="tabcontent">
        ...
        <div class="col-md-12" >
          <h3 class="quickFacts_anchor">2019-2020 VARSITY ATHLETES
          </h3>   
        </div>
        <div class="col-md-12 detailOff" >
      ...
      <!--change school pofile-->
      <div id="changeProfile" class="tabcontent">
        <div class="col-md-12 primaryCollegeName">
          <h2><?php echo $clgInfo['INSTNM']; ?> <span class="statName"> <?php echo  $clgInfo['CITY'].', '.$clgInfo['STABBR']; ?></span></h2>
        </div>
        <div class="col-sm-12">
          <h3 class="quickFacts_anchor">User Input</h3>
        </div>
        <div class="col-md-12">
            <p>Isuriz curates a custom database that is the core of our powerful search tool. We begin with the strong foundational information provided by the U.S. Department of Education. Institute of Education Sciences, and National Center for Education Statistics and then through this process attempt to fold in professional guidance from career college counselors, educational consultants, admissions professionals, observational data, and student feedback to produce industry-leading results that best serve college-bound students. Unless otherwise noted with a footnote, all information provided on the school profile is by the U.S. Department of Education. Institute of Education Sciences, and National Center for Education Statistics. If you have a change request to this school profile, then complete the form below. We welcome your input.</p>            
            <form id="userInput">
              <div class="form-group">
                <label for="name">Name:</label>
                <input type="text" class="form-control" id="username" name="username" Value="<?php echo (isset($_SESSION['first_name']))?$_SESSION['first_name']:""; ?>" >
              </div>
              <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" class="form-control" id="email" name="email" value="<?php echo (isset($_SESSION['emailid']))?$_SESSION['emailid']:""; ?>" >
              </div>
              <div class="form-group">
                ...
                if(isset($_SESSION['usertype'])){                  
                  if($_SESSION['usertype'] == "College_Counselor"){
                    $userType = "College Counselor";
                  }else{
                    $userType = "Student";
                  }
                }
                ?>
                <input type="text" class="form-control" id="usertype" name="usertype" value="<?php echo $userType; ?>" >
              </div>
              <div class="form-group">
                <label for="comment">Change Request: <small class="text-danger">*</small></label>
                <textarea class="form-control" rows="5" id="comment" name="comment" required></textarea>
              </div>
              <div class="form-group">
                <label for="usertype">Source:</label>
                <input type="source" class="form-control" id="source" name="source">
              </div>
              <div class="checkbox">
                <label><input type="checkbox" name="accept" value="1"> By submitting this change request, you consent to being publicly disclosed as the source, and grant Isuriz and any user of Isuriz the irrevocable license to use this proposed edit freely and in perpetuity. If you are providing general feedback and bringing a detail to our attention, please click N/A.</label>
              </div>
              <div class="checkbox">
                <label><input type="checkbox" name="accept_1" value="1"> N/A</label>
              </div>
              <div class="form-group">
                <button type="submit" class="btn btn-primary mybluebtn">Submit</button>
              </div>
